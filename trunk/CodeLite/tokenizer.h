 ...
 *
 * \code
 * StringTokenizer tok(wxT("first second third"), wxT(" "));
 * while( tok.HasMore() )
 * {
 ...
 * delimArr.Add("wxT("-"));
 * delimArr.Add("wxT(":"));
 * StringTokenizer tok(wxT("first-second:third"), delimArr);
 * \endcode 
 * 
...
public:
	 ...
	 */
	StringTokenizer(const wxString& str,const wxString& delimiter = wxT(" ") , const bool &bAllowEmptyTokens = false);
