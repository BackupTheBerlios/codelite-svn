...
short cl_var_defred[] = {                                     10,
   ...
   20,    0,   34,   36,   37,   26,    0,   24,   21,   22,
   23,   25,   19,    0,   16,   29,    0,    0,   47,    0,
   28,   17,    0,   27,   18,
};
...
short cl_var_sindex[] = {                                      0,
 -252,    0,    0,  -30,    0,    0,    0,    0,    0,    0,
    ...
    0,   19,    0,    0,    0,    0, -267,    0,    0,    0,
    0,    0,    0,  -32,    0,    0, -313, -267,    0, -284,
    0,    0,  -58,    0,    0,
};
...
short cl_var_gindex[] = {                                      0,
    0,    0,    0,    0,    0,  -25,   13,  -19,  -17,    0,
    0,    0,    0,    0,    0,    0,    0,
};
#define YYTABLESIZE 283
short cl_var_table[] = {                                      15,
   37,   54,   12,    2,   46,   13,   29,   33,   46,    7,
   35,   48,   31,   51,   35,   33,   35,   15,   53,   34,
   12,   12,   52,   12,   14,   33,   50,   10,    5,   49,
    6,   38,   38,    0,   35,   55,   38,    0,    0,   31,
...
short cl_var_check[] = {                                      44,
   ...
   38,   44,  303,  327,   42,   38,   44,   62,  303,   42,
   58,   59,   48,   61,   12,   62,   46,   58,   59,   62,
   61,  258,  259,   -1,   62,   53,  263,   -1,   -1,  258,
