...
DECLARE_EVENT_TYPE(wxEVT_FRD_FIND_NEXT, -1)
DECLARE_EVENT_TYPE(wxEVT_FRD_CLOSE, -1)
DECLARE_EVENT_TYPE(wxEVT_FRD_REPLACE, -1)
DECLARE_EVENT_TYPE(wxEVT_FRD_REPLACEALL, -1)
DECLARE_EVENT_TYPE(wxEVT_FRD_BOOKMARKALL, -1)
