...
WX_DECLARE_USER_EXPORTED_OBJARRAY(wxRect, wxRectArray, WXDLLIMPEXP_FNB);

/// The tab area window
class WXDLLIMPEXP_FNB wxStyledTabsContainer : public wxPageContainerBase
{
	int m_factor;
public:
...
class WXDLLIMPEXP_FNB wxStyledNotebook : public wxFlatNotebookBase 
{
public:
	/**
	 *
