...
#ifndef FLATMENU_SMART_PTR_H
#define FLATMENU_SMART_PTR_H
...
public:
	 ...
	 */
	fmSmartPtr(const fmSmartPtr& rhs)
		: m_ref(NULL)
	{
		*this = rhs;
	}
	 ...
	 */
	fmSmartPtr& operator=(const fmSmartPtr& rhs)
	{
