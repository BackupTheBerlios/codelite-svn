...
public:
  ...
  {                                    // arg1 =          arg2 =
    ...
    SQLITE_MAX_CODE            = SQLITE_ANALYZE
  };
...
public:
  ...
  */
  ...
  /**
  * \param dbName is either the name of the database (i.e. "main", "temp" or an attached database) or an empty string. If it is an ampty string all attached databases are searched for the table.
