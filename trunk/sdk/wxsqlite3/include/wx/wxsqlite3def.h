...
\section intro What is wxSQLite3?
  ...
  - <a href="http://sourceforge.net/projects/wxsqlite">wxSQLite</a> :
    ...
    Current version of SQLite is 3.3.6 having a lot more features - which are not supported by this wrapper.
  ...
  of the SQLite3 version 3.3.6 are supported, like for example the creation of user defined
